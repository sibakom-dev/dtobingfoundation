...
ourStoryImage: /media/yayasan darius tobing (about us).jpeg
...
valuesList:
  ...
  - name: Compassion
    description: We lead with empathy, for artisans, for communities, and for animals.
  - name: Integrity
    description: We operate with full transparency and accountability to our donors, partners, and beneficiaries.
  - name: Sustainability
    description: We build programs that create lasting systemic change, not just short-term relief.
foundersList:
  - name: The Darius Tobing Foundation
    role: Jakarta, Indonesia
    image: /media/background_website_2mb.png
partnersList:
  - name: Paisley Things
